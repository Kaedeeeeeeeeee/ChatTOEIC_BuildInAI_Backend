...
export {
  ...
  generalChatPrompt,
  encouragementPrompt
} from './interaction/chatPrompts.js';

export {
  buildAnswerExplanationPrompt,
  buildGrammarExplanationPrompt,
  buildErrorAnalysisPrompt,
  buildQuestionTypeAnalysisPrompt
} from './interaction/explanationPrompts.js';

export {
  buildWordDefinitionPrompt,
  buildVocabularyReviewPrompt,
  buildWordUsagePrompt,
  buildSynonymAnalysisPrompt
} from './interaction/vocabularyPrompts.js';

// 提示词映射函数，用于根据题目类型选择对应的提示词函数
export const getQuestionPromptFunction = (questionType: string) => {
