-- 🚨 EMERGENCY SQL FIX FOR RAILWAY PRODUCTION DATABASE
-- vocabulary_items table missing columns repair
-- Run this manually in Railway database console if needed

-- Add all missing columns to vocabulary_items table
