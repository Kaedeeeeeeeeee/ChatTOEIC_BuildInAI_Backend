...
export const schemas = {
    ...
    questionGeneration: Joi.object({
        ...
        difficulty: Joi.string().valid('UNDER_500', 'LEVEL_500_600', 'LEVEL_600_700', 'LEVEL_700_800', 'OVER_800', 
        // 向后兼容旧的难度级别
        'BEGINNER', 'INTERMEDIATE', 'ADVANCED').required(),
    ...
    chatRequest: Joi.object({
        ...
        questionContext: Joi.object({
            ...
            difficulty: Joi.alternatives().try(Joi.string().valid('BEGINNER', 'INTERMEDIATE', 'ADVANCED'), Joi.number()).optional(),
