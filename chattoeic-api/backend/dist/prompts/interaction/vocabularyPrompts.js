export const buildWordDefinitionPrompt = (word, context) => {
    return `
...
export const buildVocabularyReviewPrompt = (words, difficulty) => {
    return `
...
export const buildWordUsagePrompt = (word, partOfSpeech) => {
    return `
...
export const buildSynonymAnalysisPrompt = (words) => {
    return `
